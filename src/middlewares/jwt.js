...
module.exports = (req, res, next) => {
  ...
  const rotaPublica = rotasPublicas.find((rota) => {
    ...
    return (
      // os parentesis definem a prioridade de verificação das condições
      // verifica se a rota da requisição é identica
      (rota.url === req.url || // ou a rota publica contem um '*' e a rota da requisição possui como parte da url a rota publica
